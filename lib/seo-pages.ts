...
export const manychatAlternativePage: SeoPageConfig = {
  ...
  description:
    "MyReply is for teams that do not need a broad chatbot builder. It turns keyword comments into Meta-compliant private replies, tracked links, campaign analytics, and client reports.",
  ...
  sections: [
    {
      ...
      body: "Broad automation suites can be powerful, but they also add flow-builder weight. MyReply keeps the campaign path tight: keyword, post, reply, link, result.",
    },
    {
      title: "Agency proof",
  ...
  comparisonTitle: "MyReply vs broad chatbot builders",
  comparisons: [
    {
      label: "Setup",
  ...
  faqs: [
    {
      title: "Is MyReply a full Manychat replacement?",
      body: "No. MyReply is intentionally focused on Instagram comment-to-DM campaigns. If you need a complete chatbot suite, use a broad platform. If you need fast campaign loops, MyReply is built for that.",
    },
    {
...
export const commentLinkSeoPage: SeoPageConfig = {
  ...
  faqs: [
    ...
    {
      title: "Does MyReply send a normal Instagram DM?",
